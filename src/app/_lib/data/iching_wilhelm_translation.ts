//Modified from https://github.com/adamblvck/iching-wilhelm-dataset
...
export type Hexagram = {
    ...
    wilhelm_lines: { [key: string]: { text: string; comments: string } };
};

const HexagramManifest: Record<string, Hexagram> = {
    "1": {
        hex: 1,
        hex_font: "\u4dc0",
        trad_chinese: "\u4e7e",
        ...
        wilhelm_lines: {
            ...
            "2": {
                text: "Dragon appearing in the field.\nIt furthers one to see the influential one.",
                comments:
                    "Here the effects of the light-giving power begin to manifest themselves. In terms of human affairs, this means that the influential one makes his appearance in his chosen field of activity. As yet he has no commanding position but is still with his peers. However, what distinguishes him form the others is his seriousness of purpose, his unqualified reliability, and the influence he exerts on his environment with out conscious effort. Such a man is destined to gain great influence and to set the world in order. Therefore it is favorable to see him.",
            },
            "3": {
                text: "All day long the upright person is creatively active.\nAt nightfall his mind is still beset with cares.\nDanger. No blame.",
                comments:
                    "A sphere of influence opens up for the influential one. His fame begins to spread. The masses flock to him. His inner power is adequate to the increased outer activity. There are all sorts of things to be done, and when others are at rest in the evening, plans and anxieties press in upon him. But danger lurks here at the place of transition from lowliness to the heights. Many a great man has been ruined because the masses flocked to him and swept him into their course. Ambition has destroyed his integrity. However, true greatness is not impaired by temptations. He who remains in touch with the time that is dawning, and with its demands is prudent enough to avoid all pitfalls, and remains blameless.",
            },
            "4": {
                text: "Wavering flight over the depths.\nNo blame.",
                comments:
                    "A place of transition has been reached, and free choice can enter in. A twofold possibility is presented to the influential one: he can soar to the heights and play an important part in the world, or he can withdraw into solitude and develop himself. He can go the way of the hero or that of the holy sage who seeks seclusion. There is no general law of his being. If the individual acts consistently and is true to himself, he will find the way that is appropriate for him. This way is right for him and without blame.",
            },
            "5": {
                text: "Flying dragon in the heavens.\nIt furthers one to see the influential one.",
                comments:
                    "Here the influential one has attained the sphere of the heavenly beings. His influence spreads and becomes visible throughout the whole world. Everyone who sees him may count himself blessed. Confucius says about this line:\n\nThings that accord in tone vibrate together. Things that have affinity in their inmost natures seek one another. Water flows to what is wet, fire turns to what is dry. Clouds (the breath of heaven) follow the dragon, wind (the breath of earth) follows the tiger. Thus the sage arises, and all creatures follow him with their eyes. What is born of heaven feels related to what is above. What is born of earth feels related to what is below. Each follows its kind.",
            },
            "6": {
    ...
    "5": {
        ...
        wilhelm_image: {
            text: "Clouds rise up to heaven:\nThe image of WAITING.\nThus the upright person eats and drinks,\nIs joyous and of good cheer.",
            comments:
    ...
    "7": {
        ...
        wilhelm_lines: {
            ...
            "2": {
                text: "In the midst of the army.\nGood fortune. No blame.\nThe ruler bestows a triple decoration.",
                comments:
    ...
    "8": {
        ...
        wilhelm_lines: {
            ...
            "2": {
                ...
                comments:
                    "If a person responds perseveringly and in the right way to the behests from above that summon him to action, his relations with others are intrinsic and he does not lose himself. But if a man seeks association with others as if he were an obsequious office hunter, he throws himself away. He does not follow the path of the upright person, who never loses his dignity.",
            },
            "3": {
    ...
    "9": {
        ...
        wilhelm_image: {
            text: "The wind drives across heaven:\nThe image of THE TAMING POWER OF THE SMALL.Thus the upright person\nRefines the outward aspect of his nature.",
            comments:
    ...
    "10": {
        ...
        wilhelm_image: {
            text: "Heaven above, the lake below:\nThe image of TREADING.\n\nThus the upright person discriminates between high and low,\nAnd thereby fortifies the thinking of the people.",
            comments:
    ...
    "12": {
        ...
        wilhelm_lines: {
            ...
            "2": {
                text: "They bear and endure;\nThis means good fortune for inferior people.\nThe standstill serves to help the influential one to attain success.",
                comments:
                    "Inferior people are ready to flatter their superiors in a servile way. They would also endure the upright person if he would put an end to their confusion. This is fortunate for them. But the influential one calmly bears the consequences of the standstill. He does not mingle with the crowd of the inferior; that is not his place. By his willingness to suffer personally he insures the success of his fundamental principles.",
            },
            "3": {
    ...
    "13": {
        ...
        trad_chinese: "\u540c\u4eba",
        pinyin: "t\u00f3ngr\u00e9n",
        english: "Fellowship with People",
        lines: "787777",
        wilhelm_above: { chinese: "CH'IEN", symbolic: "THE CREATIVE,", alchemical: "HEAVEN" },
        ...
        wilhelm_judgment: {
            text: "FELLOWSHIP WITH PEOPLE in the open.\n\nSuccess.\nIt furthers one to cross the great water.\nThe perseverance of the upright person furthers.",
            comments:
                "True fellowship among men must be based upon a concern that is universal. It is not the private interests of the individual that create lasting fellowship among men, but rather the goals of humanity. That is why it is said that fellowship with people in the open succeeds. If unity of this kind prevails, even difficult and dangerous tasks, such as crossing the great water, can be accomplished. But in order to bring about this sort of fellowship, a persevering and enlightened leader is needed--a man with clear, convincing, and inspiring aims and the strength to carry them out. (The inner trigram means clarity; the outer, strength.)",
        },
        wilhelm_image: {
            text: "Heaven together with fire:\n\nThe image of FELLOWSHIP WITH PEOPLE.\nThus the upright person organizes the clans\nAnd makes distinctions between things.",
            comments:
        ...
        wilhelm_lines: {
            "1": {
                text: "Fellowship with people at the gate.\nNo blame.",
                comments:
            ...
            "2": {
                text: "Fellowship with people in the clan.\nHumiliation.",
                comments:
            ...
            "6": {
                text: "Fellowship with people in the meadow.\nNo remorse.",
                comments:
    ...
    "14": {
        ...
        wilhelm_image: {
            text: "Fire in heaven above:\n\nThe image of POSSESSION IN GREAT MEASURE.\nThus the upright person curbs evil and furthers good,\nAnd thereby obeys the benevolent will of heaven.",
            comments:
    ...
    "20": {
        ...
        wilhelm_lines: {
            ...
            "5": {
                text: "Contemplation of my life.\nThe upright person is without blame.",
                comments:
    ...
    "23": {
        ...
        wilhelm_lines: {
            "1": {
                ...
                comments:
                    "Inferior people are on the rise and stealthily begin their destructive burrowing from below in order to undermine the place where the upright person rests. Those followers of the ruler who remain loyal are destroyed by slander and intrigue. The situation bodes disaster, yet there is nothing to do but wait.",
            },
            "2": {
    ...
    "26": {
        ...
        wilhelm_image: {
            text: "Heaven within the mountain:\n\nThe image of THE TAMING POWER OF THE GREAT.\n\nThus the upright person acquaints himself with many sayings of antiquity\nAnd many deeds of the past,\nIn order to strengthen his character thereby.",
            comments:
    ...
    "27": {
        ...
        wilhelm_judgment: {
            text: "THE CORNERS OF THE MOUTH.\nPerseverance brings good fortune.\nPay heed to the providing of nourishment\nAnd to what a man seeks\n\nTo fill his own mouth with.\n\nIn bestowing care and nourishment, it is important that the right people should be taken care of and that we should attend to our own nourishment in the right way. If we wish to know what anyone is like, we have only to observe on whom he bestows his care and what sides of his own nature he cultivates and nourishes. Nature nourishes all creatures. The influential one fosters and takes care of superior men, in order to take care of all men through them. Mencius says about this:",
            comments:
        ...
        wilhelm_image: {
            text: "At the foot of the mountain, thunder:\n\nThe image of PROVIDING NOURISHMENT.\n\nThus the upright person is careful of his words\nAnd temperate in eating and drinking.",
            comments:
                '"God comes forth in the sign of the Arousing": when in the spring the life forces stir again, all things comes into being anew. "He brings to perfection in the sign of Keeping Still": thus in the early spring, when the seeds fall to earth, all things are made ready. This is an image of providing nourishment through movement and tranquillity. the upright person takes it as a pattern for the nourishment and cultivation of his character. Words are a movement going form within outward. Eating and drinking are movements from without inward. Both kinds of movement can be modified by tranquillity. For tranquillity keeps the words that come out of the mouth from exceeding proper measure, and keeps the food that goes into the mouth from exceeding its proper measure. Thus character is cultivated.',
        },
        wilhelm_lines: {
            "1": {
    ...
    "29": {
        ...
        wilhelm_image: {
            text: "Water flows on uninterruptedly and reaches its foal:\n\nThe image of the Abysmal repeated.\n\nThus the upright person walks in lasting virtue\nAnd carries on the business of teaching.",
            comments:
                "Water reaches its goal by flowing continually. It fills up every depression before it flows on. the upright person follows its example; he is concerned that goodness should be an established attribute of character rather than an accidental and isolated occurrence. So likewise in teaching others everything depends on consistency, for it is only through repetition that the pupil makes the material his own.",
        },
        wilhelm_lines: {
            "1": {
    ...
    "30": {
        ...
        wilhelm_image: {
            text: "That which is bright rises twice:\n\nThe image of FIRE.\n\nThus the influential one, by perpetuating this brightness,\nIllumines the four quarters of the world.",
            comments:
                "Each of the two trigrams represents the sun in the course of a day. The two together represent the repeated movement of the sun, the function of light with respect to time. the influential one continues the work of nature in the human world. Through the clarity of his nature he causes the light to spread farther and farther and to penetrate the nature of man ever more deeply.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "6": {
                text: "The ruler used him to march forth and chastise.",
                comments:
    ...
    "31": {
        ...
        wilhelm_image: {
            text: "A lake on the mountain:\n\nThe image of influence.\n\nThus the upright person encourages people to approach him\nBy his readiness to receive them.",
            comments:
    ...
    "32": {
        ...
        wilhelm_image: {
            text: "Thunder and wind: the image of DURATION.\n\nThus the upright person stands firm\nAnd does not change has direction.",
            comments:
                "Thunder rolls, and the wind blows; both are examples of extreme mobility and so are seemingly the very opposite of duration, but the laws governing their appearance and subsidence, their coming and going, endure. In the same way the independence of the upright person is not based on rigidity and immobility of character. He always keeps abreast of the time and changes with it. What endures is the unswerving directive, the inner law of his being, which determines all his actions.",
        },
        wilhelm_lines: {
            "1": {
    ...
    "33": {
        ...
        wilhelm_image: {
            text: "Mountain under heaven: the image of RETREAT.\n\nThus the upright person keeps the inferior man at a distance,\n\nNot angrily but with reserve.",
            comments:
                "The mountain rises up under heaven, but owing to its nature it finally comes to a stop. Heaven on the other hand retreats upward before it into the distance and remains out of reach. This symbolizes the behavior of the upright person toward a climbing inferior; he retreats into his own thoughts as the inferior man comes forward. He does not hate him, for hatred is a form of subjective involvement by which we are bound to the hated object. the upright person shows strength (heaven) in that he brings the inferior man to a standstill (mountain) by his dignified reserve.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "4": {
                text: "Voluntary retreat brings good fortune to the upright person\nAnd downfall to the inferior man.",
                comments:
                    "In retreating the upright person is intent on taking his departure willingly and in all friendliness. He easily adjusts his mind to retreat, because in retreating he does not have to do violence to his convictions. The only one who suffers is the inferior man from whom he retreats, who will degenerate when deprived of the guidance of the upright person.",
            },
            "5": {
                text: "Friendly retreat. Perseverance brings good fortune.",
                comments:
                    "It is the business of the upright person to recognize in time that the moment for retreat has come. If the right moment is chosen, the retreat can be carried out within the forms of perfect friendliness, without the necessity of disagreeable discussions. Yet, for all the observance of amenities, absolute firmness of decision is necessary if one is not to be led astray by irrelevant considerations.",
            },
            "6": {
    ...
    "34": {
        ...
        wilhelm_image: {
            text: "Thunder in heaven above:\n\nThe image of THE POWER OF THE GREAT.\n\nThus the upright person does not tread upon paths\n\nThat do not accord with established order.",
            comments:
                "Thunder--electrical energy--mounts upward in the spring. The direction of this movement is in harmony with that of the movement of heaven. It is therefore a movement in accord with heaven, producing great power. However, true greatness depends on being in harmony with what is right. Therefore in times of great power the upright person avoids doing anything that is not in harmony with the established order.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "3": {
                ...
                comments:
                    "The upright person does not act thus.\n\nTo continue is dangerous.\nA goat butts against a hedge\nAnd gets its horns entangled.\n\nMaking a boast of power leads to entanglements, just as a goat entangles its horns when it butts against a hedge. Whereas an inferior man revels in power when he comes into possession of it, the upright person never makes this mistake. He is conscious at all times of the danger of pushing ahead regardless of circumstances, and therefore renounces in good time the empty display of force.",
            },
            "4": {
                text: "Perseverance brings good fortune.\nRemorse disappears.",
                comments:
    ...
    "35": {
        ...
        wilhelm_judgment: {
            ...
            comments:
                "A twofold idea is set forth here. The actual effect of the progress emanates from a man who is in a dependent position and whom the others regard as their equal and are therefore willing to follow. This leader has enough clarity of vision not to abuse his great influence but to use it rather for the benefit of his ruler. His ruler in turn is free of all jealousy, showers presents on the influential one, and invites him continually to his court. An enlightened ruler and an obedient servant--this is the condition on which great progress depends.",
        },
        wilhelm_image: {
            text: "The sun rises over the earth:\n\nThe image of PROGRESS.\n\nThus the upright person himself\nBrightens his bright virtue.",
            comments:
    ...
    "36": {
        ...
        wilhelm_image: {
            text: "The light has sunk into the earth:\n\nThe image of DARKENING OF THE LIGHT.\n\nThus does the upright person live with the great mass:\nHe veils his light, yet still shines.",
            comments:
    ...
    "37": {
        ...
        wilhelm_image: {
            text: "Wind comes forth from fire:\n\nThe image of THE FAMILY.Thus the upright person has substance in his words\nAnd duration in his way of life.",
            comments:
    ...
    "38": {
        ...
        wilhelm_image: {
            text: "Above, fire; below. The lake.\n\nThe image of OPPOSITION.\n\nThus amid all fellowship\n\nThe upright person retains his individuality.",
            comments:
    ...
    "39": {
        ...
        wilhelm_image: {
            text: "Water on the mountain:\n\nThe image of OBSTRUCTION.\n\nThus the upright person turns his attention to himself\nAnd molds his character.",
            comments:
                "Difficulties and obstructions throw a man back upon himself. While the inferior man seeks to put the blame on other persons, bewailing his fate, the upright person seeks the error within himself, and through this introspection the external obstacle becomes for him an occasion for inner enrichment and education.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "2": {
                text: "The ruler's servant is beset by obstruction upon obstruction,\nBut it is not his own fault.",
                comments:
    ...
    "40": {
        ...
        wilhelm_lines: {
            ...
            "5": {
                text: "If only the upright person can deliver himself,\nIt brings good fortune.",
                comments:
    ...
    "43": {
        ...
        wilhelm_image: {
            ...
            comments:
                "When the water of a lake has risen up to heaven, there is reason to fear a cloudburst. Taking this as a warning, the upright person forestalls a violent collapse. If a man were to pile up riches for himself alone, without considering others, he would certainly experience a collapse. If a man were to pile up riches for himself alone, without considering others, he would certainly experience a collapse. For all gathering is followed by dispersion. Therefore the upright person begins to distribute while he is accumulating. In the same way, in developing his character he takes care not to become hardened in obstinacy but to remain receptive to impressions by help of strict and continuous self-examination.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "2": {
                ...
                comments:
                    "Readiness is everything. Resolution is indissolubly bound up with caution. If an individual is careful and keeps his wits about him, he need not become excited or alarmed. If he is watchful at all times, even before danger is present, he is armed when danger approaches and need not be afraid. the upright person is on his guard against what is not yet in sight and on the alert for what is not yet within hearing; therefore he dwells in the midst of difficulties as thought hey did not exist. If a man develops his character, people submit to him of their own accord. If reason triumphs, the passions withdraw of themselves. To be circumspect and not to forget one's armor is the right way to security.",
            },
            "3": {
                text: "To be powerful in the cheekbones\nBrings misfortune.",
                comments:
                    "The upright person is firmly resolved.\nHe walks alone and is caught in the rain.\nHe is bespattered,\nAnd people murmur against him.\n\nNo blame.\n\nHere we have a man in an ambiguous situation. While all others are engaged in a resolute fight against all that is inferior, he alone has a certain relationship with an inferior man. If he were to show strength outwardly and turn against this man before the time is ripe, he would only endanger the entire situation, because the inferior man would too quickly have recourse to countermeasures. The task of the upright person becomes extremely difficult here. He must be firmly resolved within himself and, while maintaining association with the inferior man, avoid any participation in his evilness. He will of course be misjudged. It will be thought that he belong to the party of the inferior man. He will be lonely because no one will understand him. His relations with the inferior man will sully him in the eyes of the multitude, and they will turn against him, grumbling. But he can endure this lack of appreciation and makes no mistake, because he remains true to himself.",
            },
            "4": {
    ...
    "45": {
        ...
        wilhelm_image: {
            text: "Over the earth, the lake:\n\nThe image of GATHERING TOGETHER.\n\nThus the upright person renews his weapons\nIn order to meet the unforeseen.",
            comments:
    ...
    "46": {
        ...
        wilhelm_image: {
            text: "Within the earth, wood grows:\n\nThe image of PUSHING UPWARD.\n\nThus the upright person of devoted character\nHeaps up small things\nIn order to achieve something high and great.",
            comments:
                "Adapting itself to obstacles and bending around them, wood in the earth grows upward without haste and without rest. Thus too the upright person is devoted in character and never pauses in his progress.",
        },
        wilhelm_lines: {
            "1": {
            ...
            "4": {
                text: "The ruler offers him Mount Ch'i.\nGood fortune. No blame.",
                comments:
    ...
    "47": {
        ...
        wilhelm_judgment: {
            text: "OPPRESSION. Success. Perseverance.\n\nThe influential one brings about good fortune.\n\nNo blame.\nWhen one has something to say,\nIt is not believed.",
            comments:
                "Times of adversity are the reverse of times of success, but they can lead to success if they; befall the right man. When a strong man meets with adversity, he remains cheerful despite all danger, and this cheerfulness is the source of later successes; it is that stability which is stronger than fate. He who lets his spirit be broken by exhaustion certainly has no success. But if adversity only bends a man, it creates in him a power to react that is bound in time to manifest itself. No inferior man is capable of this. Only the influential one brings about goof fortune and remains blameless. It is true that for the time being outward influence is denied him, because his words have no effect. Therefore in times of adversity it is important to be strong within and sparing of words.",
        },
        wilhelm_image: {
            text: "There is not water in the lake:\n\nThe image of EXHAUSTION.\n\nThus the upright person stakes his life\nOn following his will.",
            comments:
    ...
    "49": {
        ...
        wilhelm_lines: {
            ...
            "5": {
                text: "The influential one changes like a tiger.\nEven before he questions the oracle\nHe is believed.",
                comments:
            ...
            "6": {
                text: "The upright person changes like a panther.",
                comments:
    ...
    "50": {
        ...
        wilhelm_image: {
            text: "Fire over wood:\n\nThe image of THE CALDRON.\n\nThus the upright person consolidates his fate\nBy making his position correct.",
            comments:
    ...
    "51": {
        ...
        wilhelm_image: {
            text: "Thunder repeated: the image of SHOCK.\n\nThus in fear and trembling\n\nThe upright person sets his life in order\nAnd examines himself.",
            comments:
                "The shock of continuing thunder brings fear and trembling. the upright person is always filled with reverence at the manifestation of God; he sets his life in order and searches his heart, lest it harbor any secret opposition to the will of God. Thus reverence is the foundation of true culture.",
        },
        wilhelm_lines: {
            "1": {
    ...
    "53": {
        ...
        wilhelm_image: {
            text: "On the mountain, a tree:\n\nThe image of DEVELOPMENT.\n\nThus the upright person abides in dignity and virtue,\nIn order to improve the mores.",
            comments:
    ...
    "58": {
        ...
        wilhelm_image: {
            text: "Lakes resting one on the other:\n\nThe image of THE JOYOUS.\n\nThus the upright person joins with his friends\nFor discussion and practice.",
            comments:
    ...
    "59": {
        ...
        wilhelm_image: {
            text: "The wind drives over the water:\n\nThe image of DISPERSION.\n\nThus the rulers of old sacrificed to the Lord\nAnd built temples.",
            comments:
    ...
    "60": {
        ...
        wilhelm_below: { chinese: "TUI", symbolic: "THE JOYOUS,", alchemical: "LAKE" },
        wilhelm_symbolic:
            "A lake occupies a limited space. When more water comes into it, it overflows. Therefore limits must be set for the water. The image shows water below and water above, with the firmament between them as a limit. The Chinese word for limitation really denotes the joints that divide a bamboo stalk. In relation to ordinary life it means the thrift that sets fixed limits upon expenditures. In relation to the moral sphere it means the fixed limits that the upright person sets upon his actions-the limits of loyalty and disinterestedness.",
        wilhelm_judgment: {
...
export default HexagramManifest;
